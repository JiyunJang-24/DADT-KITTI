...
class Projector(nn.Module):
    def __init__(self, model_cfg):
        ...
        self.input_channels, self.middle_channels = self.model_cfg.FC1[0], self.model_cfg.FC1[1]
        self.output_channels = self.model_cfg.FC2[1]
        self.input = nn.Linear(64*(98*86), 64)
        self.conv1 = nn.Conv2d(512, 128, 3, 1)
        self.conv2 = nn.Conv2d(128, 64, 3, 1)
        self.maxpool = nn.MaxPool2d(2, 2)
        self.num_bev_features_projection = self.output_channels
    def forward(self, data_dict):
        """
        Args:
            data_dict:
        ...
        data_dict['bev_feature_projection'] = x

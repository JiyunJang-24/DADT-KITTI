...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            ...
            'backbone_2d', 'dense_head',  'point_head', 'projector', 'roi_head'
        ]
    ...
    def build_projector(self, model_info_dict):
        if self.model_cfg.get('PROJECTOR', None) is None:
            return None, model_info_dict

        projector_module = backbones_2d.__all__[self.model_cfg.PROJECTOR.NAME](
            model_cfg=self.model_cfg.PROJECTOR
        )
        model_info_dict['module_list'].append(projector_module)
        model_info_dict['project_features'] = projector_module.num_bev_features_projection
        return projector_module, model_info_dict
    ...
    def load_params_with_optimizer(self, filename, to_cpu=False, optimizer=None, logger=None):
        ...
        #self._load_state_dict(checkpoint, strict=True)

...
from ...utils import box_utils, calibration_kitti, common_utils, object3d_kitti, downsample_utils
...
class KittiDataset(DatasetTemplate):
    ...
    """
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, use_ori=False, teacher_tag=None, logger=None):
        """
        Args:
            root_path:
            dataset_cfg:
    ...
    def get_infos(self, num_workers=4, has_label=True, count_inside_pts=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            if self.split == 'test':
                return info 
            #Lidar distillation code 64 -> 32 beam dataset
            # if self.split == 'val':
            #     return info
             #LiDAR downsampling(LiDAR distillation paper ECCV 2022)
            beam = 64
            points = self.get_lidar(sample_idx)
            pc_np = points[:, :3]

...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    for i in range(num_gt):
        ...
        height = 760 * math.atan2(gt_anno["dimensions"][i][1], (gt_anno["location"][i][0]**2 + gt_anno["location"][i][2]**2)**0.5)
        valid_class = -1
    ...
    for i in range(num_dt):
        ...
        height = 760 * math.atan2(dt_anno["dimensions"][i][1], (dt_anno["location"][i][0]**2 + dt_anno["location"][i][2]**2)**0.5)

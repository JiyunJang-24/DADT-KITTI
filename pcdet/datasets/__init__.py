...
from .kitti.HMC_dataset import HMCDataset
from .kitti.Hanriver_dataset import HanriverDataset
...
__all__ = {
    ...
    'HMCDataset': HMCDataset,
    'HanriverDataset': HanriverDataset,
...
def build_dataloader_lidar_distill(dataset_cfg, class_names, batch_size, dist, root_path=None, workers=4,
    ...
    if use_ori is None:
        ...
        dataloader = DataLoader(
            ...
            shuffle=(sampler is None) and training, collate_fn=dataset.collate_batch_lidar_distillation,
            drop_last=False, sampler=sampler, timeout=0
        )

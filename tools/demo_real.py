...
def parse_config():
    ...
    # ours 
    parser.add_argument('--cfg_file', type=str, default='cfgs/VAN_models/second_res.yaml',
                        help='specify the config for demo')
    parser.add_argument('--ckpt', type=str, default="/root/Desktop/workspace/lanai11112/3DTrans/output/VAN_models/second_res_1%/adpt_flatten_seed_1/ckpt/checkpoint_epoch_80.pth")

    # default (cbgs)
    parser.add_argument('--default-ckpt', type=str, default="/root/Desktop/workspace/lanai11112/3DTrans/output/VAN_models/second_res_1%/adpt_flatten_seed_1/ckpt/checkpoint_epoch_80.pth", help='specify the pretrained model')

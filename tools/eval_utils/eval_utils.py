...
def eval_fm(cfg, model, dataloader, epoch_id, logger, dist_test=False, save_to_file=False, result_dir=None):
    result_dir.mkdir(parents=True, exist_ok=True)
    final_output_dir = result_dir / 'tsne' / 'data'
    ...
    np.save('64', np.concatenate(features, axis = 0))  
    # save the result 
